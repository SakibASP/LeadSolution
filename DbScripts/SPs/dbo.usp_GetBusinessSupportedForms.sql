...
EXEC usp_GetBusinessSupportedForms @BusinessId = 6
...
BEGIN
    ...
    SELECT 
        ...
        ISNULL(FD.IsSelectInput, 0) IsSelectInput,
        ISNULL(BSF.IsNullSupported, 1) IsNullSupported,
        ISNULL(BSF.OrderId,0) OrderId,
    ...
    WHERE FD.IsActive = 1
    ORDER BY BSF.IsActive DESC, BSF.OrderId ASC;
